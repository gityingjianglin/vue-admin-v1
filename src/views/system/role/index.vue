<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" v-show="showSearch" :inline="true" class="header-search-form" label-width="90px">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="客户端名称" width="100" key="clientName" prop="clientName" :show-overflow-tooltip="true" >
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" fixed="right" width="240" class-name="small-padding fixed-width">
        <template slot-scope="scope" v-if="scope.row.roleId !== 1">
          ...
          <el-button
            ...
            v-hasPermi="['system:role:dataScope']">数据权限</el-button>
          <!-- <el-button
            size="mini"
            type="text"
            icon="el-icon-user"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="系统管理员" prop="isClientAdmin">
          <el-select v-model="form.isClientAdmin" filterable placeholder="请选择">
            <el-option
    ...
    <el-dialog :title="title" :visible.sync="openDataScope" width="500px" append-to-body>
      <el-form :model="form" label-width="80px">
        ...
        <el-form-item label="数据权限" v-show="form.dataScope == 2">
          ...
          <el-checkbox v-model="form.orgCheckStrictly" @change="handleCheckedTreeConnect($event, 'dept')">父子联动</el-checkbox>
          <el-tree
            class="tree-border"
            :data="deptOptions"
            show-checkbox
...
import { roleOrgTreeselect } from "@/api/system/org";
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getRole(roleId).then(response => {
        if (response.data.isClientAdmin !== 0) {
          response.data.isClientAdmin = 1
        }
    ...
    submitDataScope: function() {
      if (this.form.roleId != undefined) {
        this.form.orgIds = this.getDeptAllCheckedKeys();
